        ...
        <div class="container">
            ...
            <div class="bg-white rounded-lg formulario">
                 <form class="p-4 needs-validation" action="registrar_empleados.php" method="POST" novalidate>
                  <center><label class="mt-2" for=""><h4>REGISTRAR EMPLEADOS</h4></label></center>
                <div class="form-row">
                    <div class="col-md-6 col-lg-2 mb-4">
                    <label for="validationCustom01">Id de persona</label>
                    <input type="number" class="form-control" id="validationCustom01"required name="id" placeholder="Id de persona" maxlength="11">
