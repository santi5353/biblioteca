                ...
                <div class="container-fluid" id="datos">
                    ...
                    <thead>
                        <tr class='bg-warning text-white font-weight-bold'>
                            ...
                            <th class='text-center'><small>Nombre de usuario</small></th>
                            <th class='text-center'><small>Password</small></th>
                            <th class='text-center'><small>Activo</small></th>
                                  ...
                                  while ($fila=$resultado->fetch_assoc()) {
                                    ...
                                    ?>
                                        ...
                                        <tr class='text-center'>
                                            ...
                                            <td><small>*******</small></td>
                                            <td><small><?php echo $activo; ?></small></td>
                                            <td><a class="bg-primary py-1 rounded-lg" href="modificar_usuarios.php?id=<?php echo $fila['Id_usuario'] ?>"><span class='h6 text-white icofont-ui-edit px-1'></small></a></td>
