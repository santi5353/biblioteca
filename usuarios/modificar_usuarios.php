        ...
        <div class="container">
            ...
            <div class="bg-white rounded-lg formulario">
                ...
                <form class="p-4 needs-validation" action="realizar_edicion.php?id=<?php echo $fila['Id_usuario'] ?>" method="POST" novalidate>
                  <center><label for=""><h4>ACTUALIZAR USUARIOS</h4></label></center>
                <div class="form-row">
                  ...
                  <div class="col-sm-6 col-md-6 col-lg-3 mb-4">
                    ...
                    <input type="text" class="form-control" id="validationCustom02" required name="usuario" readonly value="<?php echo $fila['Nombre_usuario'] ?>">
                  </div>
