                ...
                <div class="container-fluid" id="datos">
                    <table class='table table-sm table-hover gb-white shadow-sm'>
                        <thead>
                                ...
                                <th class='text-center'><small>Libro</small></th>
                                <th class='text-center'><small>Fecha de visita</small></th>
                                <th class='text-center'><small>Hora de entrada</small></th>
                                <th class='text-center'><small>Hora de salida</small></th>
                        ...
                        <tbody>
                            <?php 
                                if (isset($_POST['buscar'])) {
                                    ...
                                    libros.Id_libro=consulta.Id_libro AND personas.Nombre LIKE '$dato%';";
                                    $resultado=$conexion->query($query);
                                    while ($fila=$resultado->fetch_assoc()) {
                                        $id=$fila['Id_consulta']; 
                                     ?>  
                                        <tr class='text-center'>
                                            <td><small><?php echo $fila['Id_consulta']; ?></small></td>
                                            <td><small><?php echo $fila['Nombre']; ?></small></td>
                                            <td><small><?php echo $fila['Titulo']; ?></small></td>
                                            <td><small><?php echo $fila['Fecha_visita']; ?></small></td>
                                            <td><small><?php echo $fila['Hora_entrada']; ?></small></td>
                                            <td><small><?php echo $fila['Hora_salida']; ?></small></td>
