        ...
        <div class="container table-responsive">
            ...
            <form action="#" class="form" method="POST">
                ...
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                  <strong>Nota:</strong> Prestamos con retraso de entrega.
                    ...
                    <table class='table table-sm table-hover gb-white shadow-sm'>
                        ...
                        <tbody>
                            <?php 
                                ...
                                prestamos.Id_prestamo=detalle.Id_prestamo AND prestamos.Fecha_devolucion<NOW() AND prestamos.Estatus='Pendiente' ORDER BY Id_prestamo";
