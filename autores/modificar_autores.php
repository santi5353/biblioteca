        ...
        <div class="container">
            ...
            <div class="container">
                <div class="alert alert-warning alert-dismissible fade show" role="alert">
                  <strong>Nota:</strong> Dar clic en buscar libros para saber el ID del libro. <a class="text-dark" data-toggle="modal" data-target="#staticBackdrop" href=""><b> Ver libros</b></a>
            ...
            <div class="bg-white rounded-lg formulario">
                <?php 
                    $id=$_REQUEST['id'];
                    require_once("../conexion/conexion.php");
                    $query="SELECT * FROM autores,libros WHERE libros.Id_libro=autores.Id_libro AND autores.Id_autor=$id";
                    $resultado=$conexion->query($query);
                    $fila=$resultado->fetch_assoc();
                 ?>
                 <form class="p-4 needs-validation" action="realizar_edicion.php?id=<?php echo $fila['Id_autor'] ?>" method="POST" novalidate>
                  <center><label class="mt-2" for=""><h4>ACTUALIZAR AUTORES</h4></label></center>
                <div class="form-row">
                  ...
                  <div class="col-md-6 mb-4">
                    <label for="validationCustom02">Titulo del libro</label>
                    <input type="text" class="form-control" id="validationCustom02" required value="<?php echo $fila['Titulo'] ?>" readonly>
                    <div class="valid-feedback">
                      Correcto!
                    </div>
                    <div class="invalid-feedback">
