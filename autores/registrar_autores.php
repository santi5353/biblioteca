   ...
   <div class="wrapper">
        ...
        <div class="container">
            ...
            <div class="bg-white rounded-lg formulario">
                 <form class="p-4 needs-validation" action="registrar_autores.php" method="POST" novalidate>
                  <center><label class="mt-2" for=""><h4>REGISTRAR AUTORES</h4></label></center>
                <div class="form-row">
                  ...
                  <div class="col-sm-6 col-md-4 col-lg-2 mb-4">
                    ...
                    <input type="number" class="form-control" id="validationCustom02" required name="id" placeholder="Id del libro" maxlength="11">
                    <div class="valid-feedback">
                      Correcto!
                    </div>
                    <div class="invalid-feedback">
    ...
    <?php 
    	if (isset($_POST['registrar'])) {
    		...
    		$nombre=$_POST['nombre'];
    		$id=$_POST['id'];
    		$query="INSERT INTO autores (Id_libro,nombre) VALUES ($id,'$nombre')";
