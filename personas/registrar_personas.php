        ...
        <div class="menu">
            ...
            <div class="bg-white rounded-lg formulario">
                <form class="p-4 needs-validation" action="registrar_personas.php" method="POST" novalidate>
                  <center><label class="mt-2" for=""><h4>REGISTRAR PERSONAS</h4></label></center>
                <div class="form-row">
                  <div class="col-sm-12 col-md-4 col-lg-6 mb-4">
                    <label for="validationCustom01">Nombre completo</label>
                    <input type="text" class="form-control" id="validationCustom01"required name="nombre" placeholder="Nombre completo" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]+" maxlength="40">
                  ...
                  <div class="col-sm-12 col-md-4 col-lg-3 mb-4">
                    ...
                    <input type="text" class="form-control" id="validationCustom02" required name="barrio" placeholder="Barrio" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]+" maxlength="16">
                    <div class="valid-feedback">
                      Correcto!
                    </div>
                    <div class="invalid-feedback">
                  ...
                  <div class="col-sm-12 col-md-4 col-lg-3 mb-4">
                    ...
                    <input type="text" class="form-control" id="validationCustom03" required name="calle" placeholder="Calle" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]+" maxlength="16">
                    <div class="valid-feedback">
                      Correcto!
                    </div>
                    <div class="invalid-feedback">
                 ...
                 <div class="form-row">
                  <div class="col-sm-6 col-md64 col-lg-3 mb-3">
                    ...
                    <input type="text" class="form-control" id="validationCustom04" required name="numero" placeholder="Número de casa" pattern="[0-9]+" maxlength="3">
                    <div class="valid-feedback">
                      Correcto!
                    </div>
                    <div class="invalid-feedback">
                  ...
                  <div class="col-sm-6 col-md-6 col-lg-3 mb-3">
                    ...
                    <input type="text" class="form-control" id="validationCustom05" required name="estado" placeholder="Estado" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]+" maxlength="18">
                    <div class="valid-feedback">
                      Correcto!
                    </div>
                    <div class="invalid-feedback">
                  ...
                  <div class="col-sm-6 col-md-6 col-lg-3 mb-3">
                    ...
                    <input type="text" class="form-control" id="validationCustom06" required name="ciudad" placeholder="Ciudad" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]+" maxlength="18">
                    <div class="valid-feedback">
                      Correcto!
                    </div>
                    <div class="invalid-feedback">
                 ...
                 <div class="form-row">
                  ...
                  <div class="col-sm-6 col-md-4 col-lg-3 mb-3">
                    ...
                    <input type="tel" class="form-control" id="validationCustom09" required name="telefono" placeholder="Teléfono" pattern="[0-9]{8,10}">
                    <div class="valid-feedback">
                      Correcto!
                    </div>
                    <div class="invalid-feedback">
                  ...
                  <div class="col-sm-6 col-md-4 col-lg-6 mb-3">
                    ...
                    <input type="email" class="form-control" id="validationCustom10" name="correo" placeholder="Correo" maxlength="50" pattern="^[a-zA-Z0-9.!#$%&’*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$">
                    <div class="valid-feedback">
                      Correcto!
                    </div>
                    <div class="invalid-feedback">
