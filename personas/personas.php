                ...
                <div class="form-row container">
                    <div class="col-md-6 col-lg-5">
                        <div class="input-group">
                            <input type="search" name="dato" placeholder="Nobre de la persona" class="form-control shadow-sm border-0" autocomplete="off">
                            ...
                            <?php 
                                ...
                                ?>
                                    <tr class='text-center'>
                                            <td><small><?php echo $fila['Id_persona'];?></small></td>
                                            <td><small><?php echo $fila['Nombre'];?></small></td>
                                            <td><small><?php echo $fila['Barrio'];?></small></td>
                                            <td><small><?php echo $fila['Calle'];?></small></td>
                                            <td><small><?php echo $fila['Numero'];?></small></td>
                                            <td><small><?php echo $fila['Estado'];?></small></td>
                                            <td><small><?php echo $fila['Ciudad'];?></small></td>
                                            <td><small><?php echo $fila['Sexo'];?></small></td>
                                            ...
                                            <td><a class="bg-primary py-1 rounded-lg" href="modificar_personas.php?id=<?php echo $fila['Id_persona'] ?>"><span class='h6 text-white icofont-ui-edit px-1'></span></a></td>
